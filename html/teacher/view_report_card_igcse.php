...
// Determine overall grade for IGCSE (9-1 scale)
if ($mean_grade_points >= 8.5) $overall_grade = '9';
elseif ($mean_grade_points >= 7.5) $overall_grade = '8';
elseif ($mean_grade_points >= 6.5) $overall_grade = '7';
elseif ($mean_grade_points >= 5.5) $overall_grade = '6';
elseif ($mean_grade_points >= 4.5) $overall_grade = '5';
elseif ($mean_grade_points >= 3.5) $overall_grade = '4';
elseif ($mean_grade_points >= 2.5) $overall_grade = '3';
elseif ($mean_grade_points >= 1.5) $overall_grade = '2';
elseif ($mean_grade_points >= 0.5) $overall_grade = '1';
...
<div class="report-card">
    ...
    <div style="margin-bottom: 15px; font-size: 11px; padding: 10px; background: #f0f0f0; border-radius: 4px;">
        <strong>GRADING SCALE (IGCSE 9-1):</strong> 
        9 (90-100) | 8 (80-89) | 7 (70-79) | 6 (60-69) | 5 (50-59) | 
        4 (40-49) | 3 (30-39) | 2 (25-29) | 1 (20-24) | U (0-19) Ungraded
    </div>
